...
class FavoritesController  extends MobileHomeController
{
    ...
    public function indexAction ()
    {
        ...
        $array['page']= $page;
        $array['favorites_list'] = $this->getDbshopTable('UserFavoritesTable')->listFavorites(array('page'=>$page, 'page_num'=>10), array('dbshop_user_favorites.user_id'=>$this->getServiceLocator()->get('frontHelper')->getUserSession('user_id')));
        $array['favorites_list']->setPageRange(3);
